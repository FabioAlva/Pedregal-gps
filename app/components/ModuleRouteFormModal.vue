...
const confirmSave = () => {
  emit('save', {
    ...
    metodo: form.value.tipoRuta === 'backend' ? (form.value.metodo || null) : null,
    accionRequerida: form.value.tipoRuta === 'backend' ? (form.value.accionRequerida || null) : null,
