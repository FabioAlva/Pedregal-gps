...
const props = defineProps<{
  color: string
  size?: number
  backgroundColor?: string // Nueva prop opcional para el color de fondo
}>()
...
<style scoped>
.car-icon-container {
  /* He ajustado la sombra para que sea más sutil con el fondo */
